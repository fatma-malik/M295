...
const secretAdminCredentials = { email: "exampel@smth.com", password: "m295" };
...
app.post("/login", (req, res) => {
    ...
    if (email === secretAdminCredentials.email && password === secretAdminCredentials.password) {
...
app.post("/lends", isAuthenticated, validateLend, (req, res) => {
    const { customer_id, isbn } = req.body;
    const lend = {
